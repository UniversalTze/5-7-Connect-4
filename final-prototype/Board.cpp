...
class Board {
    public:
        // Public variables
        int board[BOARD_HEIGHT][BOARD_WIDTH] = {EMPTY}; //use instead of getBoard
        int prevBoard[BOARD_HEIGHT][BOARD_WIDTH] = {EMPTY}; // use instead of getPrevBoard

        // Public functions
        /**
         * @brief Constructs a Board object.
         *
         * This constructor initializes a Board object with the specified
         * dimensions. The number of rows is set to BOARD_HEIGHT and the number
         * of columns is set to BOARD_WIDTH.
         */
        Board() : m_row(BOARD_HEIGHT), m_col(BOARD_WIDTH) {};
